...
class InfoServiceClientLegacy(ClientBaseWithDataset):
    def __init__(
        ...
        super(InfoServiceClientLegacy, self).__init__(
            server_address,
            auth_header,
            api_version,
            endpoints,
    ...
    def _get_property(
        ...
        return output_map.get(format_for, format_raw)(
            self.info_cache[dataset_name].get(info_property, None)
        )
    ...
    def annotation_endpoint(self, dataset_name=None, use_stored=True):
        ...
        return self._get_property(
            "annotation_engine_endpoint",
            dataset_name=dataset_name,
            use_stored=use_stored,
            output_map=output_map_raw,
        )

    def flat_segmentation_source(
        self, dataset_name=None, use_stored=True, format_for="raw"
    ):
    ...
    def supervoxel_source(self, dataset_name=None, use_stored=True, format_for="raw"):
        ...
        """
        return self._get_property(
            "pychunkedgraph_supervoxel_source",
            dataset_name=dataset_name,
            use_stored=use_stored,
            format_for=format_for,
            output_map=output_map_precomputed,
    ...
    def pychunkedgraph_segmentation_source(
        self, dataset_name=None, use_stored=True, format_for="raw"
    ):
        return self._get_property(
    ...
    def pychunkgraph_segmentation_source(self, **kwargs):
        warn(
            "Please use " "pychunkedgraph_segmentation_source" " in the future.",
            DeprecationWarning,
        )
    ...
    def graphene_source(self, dataset_name=None, use_stored=True, format_for="raw"):
