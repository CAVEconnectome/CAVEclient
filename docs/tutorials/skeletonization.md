...
The skeletons provided by the CAVEclient.SkeletonClient are generated by [pcg_skel](https://caveconnectome.github.io/pcg_skel/), which itself relies upon [MeshParty](https://meshparty.readthedocs.io/en/latest/) for the underlying skeletonization process. Please see the associated documentation for more information.
